-- Best-effort restore of the billing schema (structure only — subscription
-- data and Lemon Squeezy config are not recoverable).
...
CREATE TABLE payment_config (
  ...
  live_tier_personal_monthly TEXT,
  live_tier_personal_yearly TEXT,
  live_tier_pro_monthly TEXT,
  live_tier_pro_yearly TEXT,
  live_tier_studio_monthly TEXT,
  live_tier_studio_yearly TEXT
);
